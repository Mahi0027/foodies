...
<?php $this->load->view('admin/header'); ?>
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form action="<?php echo base_url('admin/user/user_add_row')?>" method="post">
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-lg-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" name="middle_name" type="text">
                <?php
              ...
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" name="mobile_no" type="Number">
                <?php
            ...
            <div class="col-sm-6 col-lg-6">
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" name="refer_code" type="text">
                <?php
              ...
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" name="refer_by" type="text">
                <?php
              ...
              <div class="form-group">
                ...
                <input class="form-control form-control-sm" name="marital_status" type="text">
                <?php
              ...
              <div class="form-group">
                <label>Address :</label>
                <textarea class="form-control form-control-sm" name="address" rows="3" ></textarea>
                <?php
              ...
              <div class="form-group">
                <label>Pincode :</label>
                <input class="form-control form-control-sm" name="pincode" type="Number">
                <?php
